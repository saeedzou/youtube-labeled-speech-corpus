...
def main():
    ...
    parser.add_argument("--min_wer", type=float, default=0.8, help="Maximum word error rate.")
    parser.add_argument("--min_cer", type=float, default=0.2, help="Maximum character error rate.")
    parser.add_argument("--min_punct", type=int, default=5, help="Minimum common punctuation count.")
